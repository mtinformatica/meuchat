    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: "#2a89ff" },
                textPrimary: mode === "light" ? "#2a89ff" : "#FFFFFF",
                borderPrimary: mode === "light" ? "#2a89ff" : "#FFFFFF",
                dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
                light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
                tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
                optionsBackground: mode === "light" ? "#fafafa" : "#333",
				options: mode === "light" ? "#fafafa" : "#666",
				fontecor: mode === "light" ? "#2a89ff" : "#fff",
                ...
                barraSuperior: mode === "light" ? "linear-gradient(to right, #2a89ff, #2a89ff, #2a89ff)" : "#666",
